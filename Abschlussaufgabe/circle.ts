...
//        stachel:boolean;
        ...
        constructor(_x:number,_y:number) {
            ...
            this.x = 1190;
            this.y = 475;
            this.draw(Math.floor((Math.random() * canvas.width) + 50),Math.floor((Math.random() * 500) + 50),"hsl(" + Math.random() * 360 + ", 100%, 50%)")
//            this.setRandomStyle();
...
//    }
    ...
    makeCircleInvisible (_x:number,_y:number,_fillStyle:string) : void {
